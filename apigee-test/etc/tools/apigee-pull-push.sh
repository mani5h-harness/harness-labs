...
THIRD_PARTY_COMPONENTS=( \
	"apigee-stackdriver-logging-agent:1.10.5" \
	"apigee-prom-prometheus:v2.53.1" \
	"apigee-stackdriver-prometheus-sidecar:0.9.0" \
	"apigee-kube-rbac-proxy:v0.18.0" \
	"apigee-envoy:v1.30.4" \
	"apigee-prometheus-adapter:v0.12.1" \
	"apigee-asm-ingress:1.19.10-asm.6-distroless" \
	"apigee-asm-istiod:1.19.10-asm.6-distroless" \
	"apigee-fluent-bit:3.1.3" \
	"apigee-open-telemetry-collector:v0.104.0" \
)
